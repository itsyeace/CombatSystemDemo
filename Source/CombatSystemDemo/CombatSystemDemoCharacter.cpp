...
void ACombatSystemDemoCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ACombatSystemDemoCharacter::Move);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &ACombatSystemDemoCharacter::Look);
	...
	{
		UE_LOG(LogCombatSystemDemo, Error, TEXT("'%s' Failed to find an Enhanced Input component! This template is built to use the Enhanced Input system. If you intend to use the legacy system, then you will need to update this C++ file."), *GetNameSafe(this));
	}
}

void ACombatSystemDemoCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACombatSystemDemoCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACombatSystemDemoCharacter::DoMove(float Right, float Forward)
{
...
void ACombatSystemDemoCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void ACombatSystemDemoCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void ACombatSystemDemoCharacter::DoJumpEnd()
{
